  ...
  theme: {
    extend: {
      colors: {
        ...
        muted: '#86868B',
        faint: '#B0B0B8',
        volt: '#C9F31D',        // verde lima eléctrico (acento flash)
        'volt-deep': '#A6CC00',
        'campo-violet': '#1D1D1F',
      ...
      letterSpacing: { tightest: '-0.028em', tighter2: '-0.018em', eyebrow: '0.06em' },
      borderRadius: { DEFAULT: '14px', sm: '10px', xl: '18px', '2xl': '20px', '3xl': '24px' },
      boxShadow: {
        ...
        volt: '0 6px 20px -6px rgba(201,243,29,0.5)',
      },
    },
  },
  plugins: [],
